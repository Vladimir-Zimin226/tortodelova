...
def run_image_generation(payload: Dict[str, Any]) -> Dict[str, Any]:
    """
    Celery-задача ML-воркера: перевод, генерация изображения и сохранение в хранилище.
    ...
    async def _inner() -> Dict[str, Any]:
        ...
        logger.info(
            "run_image_generation: user_id=%s credits_spent=%s task_id=%s",
            user_id,
            credits_spent,
            task_id,
        )
        ...
        # 3. Сохранение в хранилище (MinIO/S3) и формирование s3_key/public_url
